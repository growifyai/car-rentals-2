...
export const metadata = {
  title: "Privacy Policy | Zion Car Rentals",
  description: "Privacy Policy for Zion Car Rentals",
};
          ...
          <div className="prose prose-slate max-w-none space-y-6 text-sm leading-relaxed">
            ...
            <section>
              ...
              <p>
                ...
                any information. If you receive an email, a call from a person/association claiming to be Zion car rental
                service seeking any personal data like debit/credit card PIN, net-banking or mobile banking password,
                we request you to never provide such information. If you have already revealed such information, report
            ...
            <section>
              <h2 className="text-2xl font-semibold mb-4">Data Deletion and Retention</h2>
              <p>
            ...
            <section>
              ...
              <p>
                <strong>Name of the Office:</strong> Zion Car Rental Service
              </p>
              <p>
                <strong>Designation:</strong> Grievance Officer
              </p>
              <p>
                <strong>Company Name and Address:</strong><br />
                Zion Car Rental Service<br />
                8,5,199 Mallika arjuna colony old bowenpally<br />
                Hyderabad - 500011<br />
                Telangana, India
              </p>
              <p>
              ...
              <p>
                <strong>Email:</strong> <a href="mailto:Zioncarrentals90@gmail.com" className="text-primary hover:underline">Zioncarrentals90@gmail.com</a>
              </p>
              <p>
                <strong>Phone:</strong> <a href="tel:9100664083" className="text-primary hover:underline">9100664083</a><br />
