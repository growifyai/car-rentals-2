...
export const metadata = {
  title: "Terms & Conditions | Zion Car Rentals",
  description: "Terms and Conditions for Zion Car Rentals",
};
      ...
      <main className="flex-1">
        <div className="container mx-auto px-4 py-8 max-w-4xl">
          ...
          <div className="prose prose-slate max-w-none space-y-6 text-sm leading-relaxed">
            ...
            <p>
              The Platform is owned by Zion car rental service, a company incorporated under the Companies
              Act, 1956 with its registered office at 8,5,199, Mallika arjuna colony old bowenpally ,
            ...
            <ol className="list-decimal list-inside space-y-4 ml-4">
              ...
              <li>
                ...
                jurisdiction of the courts in Hyderabad and Telangana.
              </li>
              <li>
