...
import type { InvoiceOrderData } from './Invoice';
...
interface CheckoutProps {
  items: CartItem[];
  onPayment: (orderData: InvoiceOrderData) => void;
  onBack: () => void;
}
...
export function Checkout({ items, onPayment, onBack }: CheckoutProps) {
  ...
  const handleCardChange = <K extends keyof CardFormData>(field: K, value: CardFormData[K]) => {
