  ...
  const contactInfo = [
    {
      ...
      title: 'Phone Support',
      details: '9100664083',
      description: 'Available Monday - Friday, 9:00 - 18:00'
    },
    {
      icon: Mail,
      title: 'Email Support',
      details: 'Zioncarrentals90@gmail.com',
      description: 'We respond within business hours'
    },
    {
      icon: MapPin,
      title: 'Head Office',
      details: '8,5,199 Mallika arjuna colony old bowenpally, Hyderabad - 500011',
